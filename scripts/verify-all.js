...
const checks = [
  ...
  ['verify:combat-parser-hostile', ['node', 'scripts/verify-combat-parser-hostile.js']],
  ...
  ['verify:passive-adapter', ['node', 'scripts/verify-passive-adapter.js']],
  ['verify:passive-static-head', ['node', 'scripts/verify-passive-static-head-trial.js']],
  ['verify:passive-local-glass', ['node', 'scripts/verify-passive-local-glass.js']],
  ...
  ['verify:operator-io-gates', ['node', 'scripts/verify-operator-io-gate-separation.js']],
