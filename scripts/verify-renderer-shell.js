...
function main() {
  ...
  assert(html.includes('runtime-control'), 'renderer should include runtime control surface');
  ...
  assert(html.includes('live-io-toggle'), 'renderer should include live IO control action');
  ...
  assert(app.includes("window.aura.invokeService('runtime.live-io.set-enabled'"), 'renderer should update live IO policy through services');
