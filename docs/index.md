...
| `adr/` | Accepted architecture decisions, including tactical scope, target-owned presentation adapter ownership, and Sense instrument-effect presentation boundaries. |
